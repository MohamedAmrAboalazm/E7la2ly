...
import com.example.android.e7la2ly.Client.ClientProfileFragment;
...
public class BarberHomeActivity extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            if (item.getItemId() == R.id.navigation_my_profile) {
                fragment = new BarberProfileFragment();

                getSupportFragmentManager().beginTransaction().replace(R.id.barber_fragmentContainer, fragment).commit();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationView navigation = findViewById(R.id.barber_navigation);
